...
int main(void)
{
  ...
  SystemClock_Config();
  MX_GPIO_Init();
  LCD1602_Begin4BIT(RS_GPIO_Port, RS_Pin, E_Pin, D4_GPIO_Port, D4_Pin, D5_Pin, D6_Pin, D7_Pin); //Inicializaci�n del Display 16x2
  ...
  while (1)
  {
     char buff[20];
		...
		LCD1602_print("Hello from ");
		LCD1602_2ndLine();
    HAL_Delay(50);
    result = TM_ADC_Read(ADC1, TM_ADC_Channel_11);
    
    sprintf(buff, "Display %4d", result);
